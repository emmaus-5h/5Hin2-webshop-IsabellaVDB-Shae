...
insert into products (name, description, code, price) values ('necklace', 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id.', '816905633-0', 10.5);
...
insert into products (name, description, code, price) values ('bracelet', 'Pellentesque at nulla. Suspendisse potenti.', '445924201-X', 13.5);
