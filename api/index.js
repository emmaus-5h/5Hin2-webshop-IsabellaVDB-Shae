...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.texture_id AS texture_id, products.ratings AS ratings, products.stock_id AS stock_id FROM products ORDER BY name')
...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.texture_id AS texture_id, products.ratings AS ratings, products.stock_id AS stock_id FROM products WHERE id = ?')
